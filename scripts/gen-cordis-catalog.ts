...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sidecarUpdates: 'sidecar-updates.md',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'sidecar-updates': 'sidecar-updates.md',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'session/reset-draft': 'client-face New Session reset signal — packages/client/runtime/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SidecarUpdatesService: 'update pipeline service is owned by packages/sdk/sidecar-updates/README.md',
  UpdateStatus: 'update pipeline status payload is owned by packages/sdk/sidecar-updates/README.md',
  InstallResult: 'update pipeline install result is owned by packages/sdk/sidecar-updates/README.md',
  NotificationPublishInput: 'notification publish input is owned by packages/host/notifications/README.md',
  NotificationView: 'notification list row is owned by packages/host/notifications/README.md',
}

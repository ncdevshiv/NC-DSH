...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-notifications': { kind: 'none', reason: 'Browser-side notice/update panel over the notifications/updates wire domains; registers nothing model-facing.' },
  ...
  'packages/client/ui-home-section': { kind: 'none', reason: 'Browser-side session-overview section; registers nothing model-facing.' },
  'packages/client/ui-team-section': { kind: 'none', reason: 'Browser-side team-overview section; registers nothing model-facing.' },
  'packages/client/ui-work-section': { kind: 'none', reason: 'Browser-side work-projection section; registers nothing model-facing.' },
  ...
  'packages/browser/browser': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-tool-browser.' },
  'packages/browser/browser-moli': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-browser.' },
  ...
  'packages/web/web-fetch-moli': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },

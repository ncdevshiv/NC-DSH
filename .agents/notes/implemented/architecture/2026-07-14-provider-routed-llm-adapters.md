...
> Superseded in part by [one LLM adapter over the ai-sidecar child process](2026-08-25-single-llm-adapter-via-ai-sdk.md): provider routing remains, the per-route protocol profile does not.

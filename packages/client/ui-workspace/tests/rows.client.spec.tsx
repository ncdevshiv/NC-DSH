...
describe('workspace browser rows', () => {
  ...
  it('workspace row menu opens on the ellipsis, renames, archives, and shows the danger delete row', () => {
    ...
    render(<ProjectRowItem
      ...
      actions={{ rename: onRename, archiveAll: onArchiveAll, delete: onDelete }} t={t}
    />)
  ...
  it('ungrouped row menu opens on the ellipsis and supports archiveAll and delete', () => {
    const onArchiveAll = vi.fn()
    const onDelete = vi.fn()
    const group: GroupNode = {
    ...
    render(<ProjectRowItem
      ...
      actions={{ archiveAll: onArchiveAll, delete: onDelete }} t={t}
    />)

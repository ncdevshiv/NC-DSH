...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.ungrouped.title': '删除聊天会话',
  'delete.ungrouped.desc': '将删除并移除所有聊天会话。',
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话将显示在“未分组”下。',
  'delete.archiveSessions': '同时归档此工作区的会话',
  'delete.pending': '正在删除工作区…',
  'group.archiveAll': '归档全部会话',
  'group.deleteAll': '删除全部会话',
  'group.archiveAll.aria': '聊天会话的操作',
  'menu.fork': '分叉会话',
  ...
  'actions.newSession.failed': '新建会话失败：{message}',
  'status.running': '进行中',
...
export const en = {
  ...
  'groupBy.flat': 'Flat list',
  'orderBy.label': 'Sort by',
  'orderBy.manual': 'Manual order',
  'orderBy.updated': 'Recently updated',
  'sessions.expand': 'Show {n} more sessions',
  'sessions.collapse': 'Show fewer',
  'empty.none': 'No sessions yet',
  'empty.noMatches': 'No matching sessions',
  ...
  'delete.ungrouped.title': 'Delete Chat Sessions',
  'delete.ungrouped.desc': 'This will delete and remove all chat sessions.',
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept. Its sessions will appear under Ungrouped.',
  'delete.archiveSessions': 'Also archive sessions in this workspace',
  'delete.pending': 'Deleting workspace…',
  'group.archiveAll': 'Archive all sessions',
  'group.deleteAll': 'Delete all sessions',
  'group.archiveAll.aria': 'Actions for chat sessions',
  ...
  'actions.newSession.failed': 'New session failed: {message}',

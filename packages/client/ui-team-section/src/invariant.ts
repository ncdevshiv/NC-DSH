/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-team-section`.
 * @module @deepseek-ai/dsh-client-ui-team-section/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-team-section'

/** Cordis companion plugin name. */
export const name = 'client-ui-team-section-invariant'

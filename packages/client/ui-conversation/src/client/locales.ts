...
export const zh = {
  ...
  'input.add': '添加',
  'input.commands': '命令',
  'input.addImages': '上传图片',
  'input.addFolder': '上传文件夹',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  ...
  'message.edit': '编辑并重发',
  'message.editResend.title': '编辑之前的消息',
  'message.editResend.body': '发送修改后的消息会把本线程回退到它之前；原会话保留 {count} 条后续回复。',
  'message.editResend.confirm': '回退并编辑',
  'message.editResend.failed': '回退失败',
  'restore.summary': '工作区已回退到编辑前状态：还原 {restored} 处文件变更。',
  'restore.conflicts': '回退不完整：{count} 个文件在移除的轮次之后被再次修改，已跳过：{paths}。',
  'restore.shell': '移除的轮次中运行了 {count} 条 shell 命令（{names}），其副作用无法回退。',
  'restore.notRestorable': '无法回退的变更工具：{names}。',
  'restore.skipped.running': '已回退到编辑前的消息；由于原线程仍在运行，工作区文件保持不变。',
  'restore.skipped.noCwd': '已回退到编辑前的消息；该会话没有工作区根目录，工作区文件保持不变。',
  ...
  'message.retry.httpStatus': 'HTTP 状态：',
  'message.retry.providerType': '提供方错误类型：',
  'message.retry.requestId': '请求 ID：',
...
export const en = {
  ...
  'input.addImages': 'Add images',
  'input.addFolder': 'Upload a folder',
  ...
  'message.editResend.title': 'Edit previous message',
  'message.editResend.body': 'Sending the edited message rewinds this thread to just before it; {count} later replies stay in the original session.',
  'message.editResend.confirm': 'Rewind and edit',
  'message.editResend.failed': 'Rewind failed',
  'restore.summary': 'Workspace rewound to before the edit: {restored} file change(s) restored.',
  'restore.conflicts': 'Rewind is partial: {count} file(s) changed again after the removed turns and were skipped: {paths}.',
  'restore.shell': '{count} shell command(s) ran in the removed turns ({names}); their side effects cannot be reverted.',
  'restore.notRestorable': 'Basis-less mutation tools: {names}.',
  'restore.skipped.running': 'Rewound before the edited message; the workspace was left untouched because the original thread is still running.',
  'restore.skipped.noCwd': 'Rewound before the edited message; the workspace was left untouched because this session has no workspace root.',
  ...
  'message.retry.httpStatus': 'HTTP status: ',
  'message.retry.providerType': 'Provider error type: ',
  'message.retry.requestId': 'Request ID: ',

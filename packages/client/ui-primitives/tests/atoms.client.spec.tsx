...
import { Button, ConnectionBanner, Input, Menu, Modal, Pill, SpectrumSurface } from '@deepseek-ai/dsh-client-ui-primitives'
...
describe('Button', () => {
  it('renders children, icon, and forwards clicks', () => {
    const onClick = vi.fn()
    render(<SpectrumSurface><Button variant="primary" icon={<svg data-testid="ic" />} onClick={onClick}>Go</Button></SpectrumSurface>)
  ...
  it('disabled blocks interaction', () => {
    const onClick = vi.fn()
    render(<SpectrumSurface><Button disabled onClick={onClick}>No</Button></SpectrumSurface>)
    fireEvent.click(screen.getByRole('button'))
    expect(onClick).not.toHaveBeenCalled()
  })

  it('outline variant renders a bordered cancel-style button', () => {
    render(<SpectrumSurface><Button variant="outline">Cancel</Button></SpectrumSurface>)

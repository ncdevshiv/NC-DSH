...
- **Only handoff startup is observable** — observation ends when the platform opener accepts spawn; a later browser exit is not reported, and the printed URL remains the manual fallback.

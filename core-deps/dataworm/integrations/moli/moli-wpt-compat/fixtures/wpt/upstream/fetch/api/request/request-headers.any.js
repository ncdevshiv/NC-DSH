...
var invalidRequestNoCorsHeaders = [
  ...
  ["Empty-Value", ""],
  ["Accept", "x".repeat(129)],
  ["Accept-Language", "x".repeat(129)],
  ["Content-Language", "x".repeat(129)],
  ["Content-Type", "text/plain;" + "x".repeat(118)],
];
...
test(function() {
  var headers = new Headers([["Accept", "x".repeat(129)]]);
  var request = new Request("", {"headers": headers, "mode": "no-cors"});
  assert_equals(request.headers.get("Accept"), null);
}, "Check that no-cors request constructor filters safelisted headers longer than 128 bytes");

...
packages/    @deepseek-ai/dsh-<pkg> workspaces at packages/<group>/<pkg>/ — the group map in packages/README.md owns group roles
python/      Python SDK and bundled runtime (see python/README.md)
native/      @deepseek-ai/node-addon-landlock-run source of record (see native/README.md)
apps/        Runnable app surfaces: CLI (apps/cli), Web GUI shell (apps/web), desktop
...
```sh
bun install            # bun workspaces, node ^22.19 || >=24, bun >=1.1
